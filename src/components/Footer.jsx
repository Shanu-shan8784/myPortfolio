      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-5 pt-2">
            <Link href="https://github.com/Shanu-shan8784" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-all transform hover:-translate-y-1">
              <FaGithub size={30} />
            </Link>
            <Link href="https://linkedin.com/in/shahnawaz-hussain" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-all transform hover:-translate-y-1">
              <FaLinkedin size={30} />
            </Link>
          </div>
        </div>
